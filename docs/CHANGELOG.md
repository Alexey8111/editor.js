...
- `Fix` - Setting `autofocus` config property to `true` cause adding `.megasreda-editor-block--focused` for the autofocused block [#1073](https://github.com/codex-team/editor.js/issues/1124)
